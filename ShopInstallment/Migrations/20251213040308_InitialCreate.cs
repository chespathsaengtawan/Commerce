            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SellerId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AllowPromptPay = table.Column<bool>(type: "bit", nullable: false),
                    AllowBillPayment = table.Column<bool>(type: "bit", nullable: false),
                    AllowTrueWallet = table.Column<bool>(type: "bit", nullable: false),
                    AllowBankTransfer = table.Column<bool>(type: "bit", nullable: false),
                    AllowCoin = table.Column<bool>(type: "bit", nullable: false),
                    PromptPayFeePercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    BillPaymentFeePercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    TrueWalletFeePercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    BankTransferFeePercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    CoinFeePercent = table.Column<decimal>(type: "decimal(5,2)", nullable: false)
                },
                constraints: table =>
                {
