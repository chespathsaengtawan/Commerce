...
namespace ShopInstallment.Controllers
{
    ...
    public class AdminUsersController : Controller
    {
        ...
        [HttpPost("/Admin/Users/AddSeller")]
        ...
        public async Task<IActionResult> AddSeller(string id)
        {
            ...
            {
                TempData["Error"] = "ไม่สามารถแก้ไขสิทธิ์ของผู้ดูแลระบบได้";
            ...
            TempData["Success"] = "เพิ่มสิทธิ์ผู้ขายให้ผู้ใช้งานแล้ว";
            return RedirectToAction(nameof(Index));
        }

        [HttpPost("/Admin/Users/RemoveSeller")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> RemoveSeller(string id)
        {
            ...
            TempData["Success"] = "ลบสิทธิ์ผู้ขายออกจากผู้ใช้งานแล้ว";
            return RedirectToAction(nameof(Index));
        }
        ...
        public async Task<IActionResult> Lock(string id)
        {
            ...
            if (await _userManager.IsInRoleAsync(user, "Admin"))
            {
                TempData["Error"] = "ไม่สามารถระงับบัญชีผู้ดูแลระบบได้";
                return RedirectToAction(nameof(Index));
            }
            ...
            {
                TempData["Error"] = "ไม่สามารถระงับบัญชีตัวเองได้";
                return RedirectToAction(nameof(Index));
            }
            ...
            TempData["Success"] = "ระงับบัญชีผู้ใช้งานเรียบร้อยแล้ว";
            return RedirectToAction(nameof(Index));
        }
        ...
        public async Task<IActionResult> Unlock(string id)
        {
            ...
            TempData["Success"] = "ปลดล็อกบัญชีผู้ใช้งานแล้ว";
            return RedirectToAction(nameof(Index));
        }
    }
}
